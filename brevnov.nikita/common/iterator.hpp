...
namespace brevnov
{
  ...
  template< typename Key, typename Value, typename Cmp, bool IsConst >
  typename Iterator< Key, Value, Cmp, IsConst >::ref Iterator< Key, Value, Cmp, IsConst >::operator*() const noexcept
  {
    assert(node_ != nullptr);
    return node_->data;
  }
  ...
  template< typename Key, typename Value, typename Cmp, bool IsConst >
  typename Iterator< Key, Value, Cmp, IsConst >::point Iterator< Key, Value, Cmp, IsConst >::operator->() const noexcept
  {
    assert(node_ != nullptr);
