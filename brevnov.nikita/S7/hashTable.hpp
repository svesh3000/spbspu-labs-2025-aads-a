...
namespace brevnov
{
  ...
  public:
    ...
    HashTable(const HashTable< Key, Value, Hash, Equal >& table):
      HashTable()
    {
    ...
    HashTable(HashTable< Key, Value, Hash, Equal >&& table):
    ...
    HashTable& operator=(const HashTable< Key, Value, Hash, Equal >& table)
    {
    ...
    HashTable& operator=(HashTable< Key, Value, Hash, Equal >&& table)
    {
      HashTable< Key, Value, Hash, Equal > temp(table);
      swap(temp);
      return *this;
    }
    ...
    {
      HashTable< Key, Value, Hash, Equal > temp(il);
      swap(temp);
      return *this;
    }
    ...
    std::pair< Iterator, bool > emplace(Args&&... args)
    {
      ...
      size_t h = Hash{}(newVal.first);
      size_t helpd = 0;
      for (size_t i = 0; i < slots_.size(); ++i)
      {
        size_t pos = (h + i) % slots_.size();
    ...
    std::pair< Iterator, bool > emplaceHint(ConstIterator hint, Args... args)
    {
      ...
      size_t h = Hash{}(newVal.first);
      size_t pos = (h + (hint.index_ - h % slots_.size())) % slots_.size();
    ...
    void swap(HashTable< Key, Value, Hash, Equal >& table) noexcept
    {
