...
int main(int argc, char** argv)
{
  ...
  commands.insert(std::make_pair("outbound", std::bind(out_bound, std::ref(std::cout), std::ref(std::cin), std::cref(graph))));
  commands.insert(std::make_pair("inbound", std::bind(in_bound, std::ref(std::cout), std::ref(std::cin), std::cref(graph))));
