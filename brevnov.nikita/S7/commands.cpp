...
namespace
{
  void bound(std::ostream& out, std::istream& in, const brevnov::Graphs& graphs, const std::string& b)
  {
    std::string graph;
    std::string vertex;
    in >> graph >> vertex;
  ...
  void addEdges(brevnov::Graph& newGraph, const brevnov::Graph::Edge& edges)
  {
...
void brevnov::input(std::istream& in, Graphs& graphs)
{
  std::string graph;
  while (in >> graph)
  {
...
void brevnov::graphs(std::ostream& out, const Graphs& graphs)
{
  if (graphs.empty())
  {
    out << "\n";
...
void brevnov::vertexes(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void brevnov::out_bound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "out");
}

void brevnov::in_bound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "in");
}

void brevnov::bind(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void brevnov::cut(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void brevnov::create(std::istream& in, Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void brevnov::merge(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string gr1;
  std::string gr2;
...
void brevnov::extract(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string graph;
  size_t count;
