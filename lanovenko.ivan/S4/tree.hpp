...
template< typename Key, typename Value, typename Comparator >
lanovenko::Tree< Key, Value, Comparator >::~Tree()
{
  clear();
}
...
template< typename Key, typename Value, typename Comparator >
lanovenko::Tree< Key, Value, Comparator >::Tree(const Tree< Key, Value, Comparator > &rhs):
  root_(nullptr),
  size_(rhs.size_)
{
...
template<typename Key, typename Value, typename Comparator>
lanovenko::Tree<Key, Value, Comparator>::Tree(Tree<Key, Value, Comparator>&& rhs) noexcept:
  root_(rhs.root_),
  size_(rhs.size_)
{}

template< typename Key, typename Value, typename Comparator >
lanovenko::Tree< Key, Value, Comparator >& lanovenko::Tree< Key, Value, Comparator >::operator=(const Tree< Key, Value, Comparator >&rhs)
{
...
template<typename Key, typename Value, typename Comparator>
lanovenko::Tree<Key, Value, Comparator>& lanovenko::Tree<Key, Value, Comparator>::operator=(Tree<Key, Value, Comparator>&& rhs) noexcept
{
  if (this == std::addressof(rhs))
  {
    return *this;
...
template< typename Key, typename Value, typename Comparator >
inline lanovenko::TreeIterator< Key, Value, Comparator > lanovenko::Tree< Key, Value, Comparator >::begin() const noexcept
{
  return TreeIterator< Key, Value, Comparator >(minValueNode(root_));
}

template< typename Key, typename Value, typename Comparator >
inline lanovenko::TreeIterator< Key, Value, Comparator > lanovenko::Tree< Key, Value, Comparator >::end() const noexcept
{
  return TreeIterator< Key, Value, Comparator >();
}

template<typename Key, typename Value, typename Comparator>
inline size_t lanovenko::Tree<Key, Value, Comparator>::size() const noexcept
{
  return size_;
}

template<typename Key, typename Value, typename Comparator>
inline bool lanovenko::Tree<Key, Value, Comparator>::empty() const noexcept
{
  return size_ == 0;
}
...
template< typename Key, typename Value, typename Comparator >
void lanovenko::Tree< Key, Value, Comparator >::clear() noexcept
{
  clear(root_);
  root_ = nullptr;
}
...
template< typename Key, typename Value, typename Comparator >
inline void lanovenko::Tree< Key, Value, Comparator >::swap(Tree< Key, Value, Comparator >& rhs) noexcept
{
...
template<typename Key, typename Value, typename Comparator>
inline lanovenko::TreeIterator<Key, Value, Comparator> lanovenko::Tree<Key, Value, Comparator>::find(const Key& key) const
{
  return find(key, Comparator{});
}

template<typename Key, typename Value, typename Comparator>
void lanovenko::Tree< Key, Value, Comparator >::insert(const std::pair< Key, Value >& value)
{
...
template< typename Key, typename Value, typename Comparator >
void lanovenko::Tree< Key, Value, Comparator >::erase(const std::pair< Key, Value >& value)
{
...
template<typename Key, typename Value, typename Comparator>
inline Value& lanovenko::Tree<Key, Value, Comparator>::at(const Key& key)
{
...
template<typename Key, typename Value, typename Comparator>
Value& lanovenko::Tree<Key, Value, Comparator>::operator[](const Key& key)
{
  TreeIterator<Key, Value, Comparator> node = find(key);
  if (node == end())
  {
...
template< typename Key, typename Value, typename Comparator >
inline unsigned short int lanovenko::Tree< Key, Value, Comparator >::height(TreeNode< Key, Value >* node) const noexcept
{
  return !node ? 0 : node->height_;
}

template<typename Key, typename Value, typename Comparator>
inline short int lanovenko::Tree< Key, Value, Comparator >::balanceFactor(TreeNode< Key, Value >* node) const noexcept
{
  return !node ? 0 : height(node->left_) - height(node->right_);
}

template< typename Key, typename Value, typename Comparator >
lanovenko::TreeNode< Key, Value >* lanovenko::Tree< Key, Value, Comparator >::rotateRight(TreeNode< Key, Value >* root) const noexcept
{
...
template< typename Key, typename Value, typename Comparator >
lanovenko::TreeNode< Key, Value >* lanovenko::Tree< Key, Value, Comparator >::rotateLeft(TreeNode < Key, Value >* root) const noexcept
{
...
template<typename Key, typename Value, typename Comparator>
lanovenko::TreeNode<Key, Value>* lanovenko::Tree<Key, Value, Comparator>::insert(TreeNode<Key, Value>* node, const std::pair<Key, Value>& value, Comparator cmp)
{
  if (!node)
  {
...
template<typename Key, typename Value, typename Comparator>
lanovenko::TreeNode<Key, Value>* lanovenko::Tree<Key, Value, Comparator>::minValueNode(TreeNode<Key, Value>* node) const
{
...
template< typename Key, typename Value, typename Comparator >
lanovenko::TreeNode< Key, Value >* lanovenko::Tree< Key, Value, Comparator >::erase(TreeNode< Key, Value >* node, const std::pair< Key, Value >& value, Comparator cmp)
{
  if (!node)
  {
    return node;
...
template< typename Key, typename Value, typename Comparator >
inline lanovenko::TreeIterator< Key, Value, Comparator > lanovenko::Tree< Key, Value, Comparator >::find(const Key& key, Comparator cmp) const
{
...
template< typename Key, typename Value, typename Comparator >
void lanovenko::Tree< Key, Value, Comparator >::clear(TreeNode< Key, Value >* root) noexcept
{
  if (!root)
  {
    return;
