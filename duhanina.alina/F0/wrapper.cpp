...
duhanina::Tree< std::string, std::function< void() >, std::less< std::string > > duhanina::initialize_commands(std::istream& in, std::ostream& out)
{
  Tree< std::string, std::function< void() >, std::less< std::string > > commands;
