...
namespace kiselev
{
  ...
  namespace detail
  {
    ...
    public:
      ...
      template< bool OtherIsConst, std::enable_if_t< IsConst && !OtherIsConst, int > = 0 >
      bool operator==(const LnrIterator< Key, Value, Cmp, OtherIsConst >&) const noexcept;
      //template< bool OtherIsConst, std::enable_if_t< IsConst && !OtherIsConst, int > = 0 >
    ...
    template< typename Key, typename Value, typename Cmp, bool IsConst >
    template< bool OtherIsConst, std::enable_if_t< IsConst && !OtherIsConst, int > >
    bool LnrIterator< Key, Value, Cmp, IsConst >::operator==(const LnrIterator<Key, Value, Cmp, OtherIsConst>& oth) const noexcept
    {
