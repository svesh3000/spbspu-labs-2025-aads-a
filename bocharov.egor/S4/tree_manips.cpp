...
void bocharov::print(std::ostream & out, std::istream & in, const MapOfTrees & mapOfTrees)
{
...
void bocharov::makeComplement(std::istream & in, MapOfTrees & mapOfTrees)
{
...
void bocharov::makeIntersect(std::istream & in, MapOfTrees & mapOfTrees)
{
