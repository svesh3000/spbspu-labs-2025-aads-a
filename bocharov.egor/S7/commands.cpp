...
namespace
{
  void bound(std::ostream & out, std::istream & in, const bocharov::Graphs & graphs, const std::string & b)
  {
    std::string graph;
    std::string vertex;
    in >> graph >> vertex;
  ...
  void addEdges(bocharov::Graph & newGraph, const bocharov::Graph::Edge & edges)
  {
...
void bocharov::input(std::istream & in, Graphs & graphs)
{
  std::string graph;
  while (in >> graph)
  {
...
void bocharov::graphs(std::ostream& out, const Graphs& graphs)
{
  if (graphs.empty())
  {
    out << "\n";
...
void bocharov::vertexes(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void bocharov::outBound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "out");
}

void bocharov::inBound(std::ostream& out, std::istream& in, const Graphs& graphs)
{
  bound(out, in, graphs, "in");
}

void bocharov::bind(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void bocharov::cut(std::istream& in, Graphs& graphs)
{
  std::string graph;
  std::string v1;
  std::string v2;
...
void bocharov::create(std::istream& in, Graphs& graphs)
{
  std::string graph;
  in >> graph;
...
void bocharov::merge(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string gr1;
  std::string gr2;
...
void bocharov::extract(std::istream& in, Graphs& graphs)
{
  std::string newGraph;
  std::string graph;
  size_t count;
